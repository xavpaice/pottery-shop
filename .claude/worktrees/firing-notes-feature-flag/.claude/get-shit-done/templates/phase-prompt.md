...
<!-- For checkpoint task examples and patterns, see @/shared/pottery-shop/.claude/get-shit-done/references/checkpoints.md -->
...
See `/shared/pottery-shop/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/shared/pottery-shop/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/shared/pottery-shop/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.

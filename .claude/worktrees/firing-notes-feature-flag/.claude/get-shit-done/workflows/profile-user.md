...
```bash
cp "/shared/pottery-shop/.claude/get-shit-done/USER-PROFILE.md" "/shared/pottery-shop/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="/shared/pottery-shop/.claude/USER-PROFILE.backup.md"
```

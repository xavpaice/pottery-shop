...
Knowledge graph is disabled. To activate:
  ...
  node /shared/pottery-shop/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node /shared/pottery-shop/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node /shared/pottery-shop/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "/shared/pottery-shop/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: /shared/pottery-shop/.claude/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"/shared/pottery-shop/.claude/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```

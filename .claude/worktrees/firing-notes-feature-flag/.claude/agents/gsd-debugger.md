...
<required_reading>
@/shared/pottery-shop/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /shared/pottery-shop/.claude
                  → checks /shared/pottery-shop/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /shared/pottery-shop/.claude/get-shit-done
                  → writes to /shared/pottery-shop/.claude/get-shit-done/hooks/
...
@/shared/pottery-shop/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/shared/pottery-shop/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/shared/pottery-shop/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/shared/pottery-shop/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/shared/pottery-shop/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```

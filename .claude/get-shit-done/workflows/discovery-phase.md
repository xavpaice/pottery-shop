...
See /shared/pottery-shop/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /shared/pottery-shop/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /shared/pottery-shop/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /shared/pottery-shop/.claude/get-shit-done/templates/discovery.md
...
Use /shared/pottery-shop/.claude/get-shit-done/templates/discovery.md.

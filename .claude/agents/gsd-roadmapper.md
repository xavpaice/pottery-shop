...
Reference full template: `/shared/pottery-shop/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/shared/pottery-shop/.claude/get-shit-done/templates/state.md`.

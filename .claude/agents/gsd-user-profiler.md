...
<reference>
@/shared/pottery-shop/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/shared/pottery-shop/.claude/get-shit-done/references/user-profiling.md` to load:

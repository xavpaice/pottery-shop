...
<execution_context>
@/shared/pottery-shop/.claude/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @/shared/pottery-shop/.claude/get-shit-done/workflows/code-review-fix.md end-to-end.

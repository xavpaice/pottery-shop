...
<execution_context>
@/shared/pottery-shop/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @/shared/pottery-shop/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>

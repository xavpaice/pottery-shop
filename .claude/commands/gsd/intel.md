...
Intel system is disabled. To activate:
  ...
  node /shared/pottery-shop/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /shared/pottery-shop/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /shared/pottery-shop/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /shared/pottery-shop/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```

...
<execution_context>
@/shared/pottery-shop/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @/shared/pottery-shop/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>

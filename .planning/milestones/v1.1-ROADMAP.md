...
Plans:
- [x] 05-01-PLAN.md — Create three TLS CI values files (letsencrypt, selfsigned, custom) in chart/clay/ci/
- [x] 05-02-PLAN.md — Append six TLS lint+template steps and behavioral test invocation to test.yml helm-lint job
...
| 5. CI Validation Extension | 2/2 | Complete   | 2026-04-14 |
